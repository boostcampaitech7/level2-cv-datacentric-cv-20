...
```
부스트코스 강의 수강 및 과제 : 24.10.28 ~ 24.10.30
데이터 EDA / 데이터 전처리 / 베이스라인 모델 학습 : 24.10.31 ~ 24.11.03
데이터 증강 및 모델 성능 개선 : 24.11.02 ~ 24.11.07
하이퍼 파라미터 튜닝 / 앙상블 : 24.11.06 ~ 24.11.07
최종 자료 정리 및 문서화 : 24.11.08 ~ 24.11.11
```
